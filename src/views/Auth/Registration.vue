                ...
                <div class="form-content">
                    ...
                    <div>
                        <div class="field input-field">
                            <input type="text" placeholder="Ім'я" class="input" v-model="name"
                                   @keyup.enter="registrationSend">
                        </div>
                        <div class="field input-field">
                            <input type="email" placeholder="Електронна пошта" class="input" v-model="email"
                                   @keyup.enter="registrationSend">
                        </div>
                        <div class="field input-field">
                        ...
                        <div class="field input-field">
                            <input type="password" placeholder="Підтвердження пароля" class="password"
                                   v-model="confirmPassword" @keyup.enter="registrationSend">
